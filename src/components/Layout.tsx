export default function Layout() {
  return (
    <>
      <div className="fixed bottom-0 mx-12 after:mx-auto after:mt-6 after:block after:h-20 after:w-[1px] after:bg-slate-300">
        <a
      ...
      <div className="fixed bottom-0 right-0 mx-12 after:mx-auto after:mt-6 after:block after:h-20 after:w-[1px] after:bg-slate-300">
        <a
